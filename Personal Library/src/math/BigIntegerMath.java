...
public class BigIntegerMath {
	...
	/**
	 * Evaluate core(n). Returns the smallest positive integer m such that n/m is
	 * a perfect square.
	 * 
	 * @param n
	 *           The non-negative argument.
	 ...
	 *           is thrown if this is outside the range 0 to the upper row index
	 *           of A.
	 * @param c
	 *           The column index of the column to be removed (0-based). An
	 *           exception is thrown if this is outside the range 0 to the upper
	 *           column index of A.
	 ...
	 * 
	 * @param A
	 *           The square matrix. If column and row dimensions are unequal, an
	 ...
	 * @since 2009-08-06
	 * @author Richard J. Mathar
	 * @see <a href="http://dx.doi.org/10.1080/01630568908816313">P. L. Butzer et
