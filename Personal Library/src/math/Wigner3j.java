...
public class Wigner3j {
	 ...
	 * @param j
	 *           The list of the integer values of the angular momenta. They are
	 *           actually the doubled j-values plus 1, whitespace separated. Only
	 *           as many as announced by the m1 parameter are used; trailing
	 *           numbers are ignored.
