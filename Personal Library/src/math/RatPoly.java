...
/**
 * A one-parameter polynomial with rational coefficients. Alternatively to be
...
class RatPoly {
	 ...
	 * a1, representing a value a0+a1*x+a2*x^2+a3*x^3+...
	 */
	 ...
	 * 
	 * @param L
	 *           the coefficients a0, a1, a2, a3,.., A deep copy of the these is
	 *           created.
	 */
	 ...
	 * 
	 * @param A
	 *           the list of values in the numerator of AFB. At least one of
	 *           these values must be a negative integer, which implicitly
	 *           determines the order of the new polynomial.
	 * @param B
	 *           the list of values in the denominator of AFB
	 * @since 2009-08-05
	 */
	...
	*/
	 ...
	 *         nonzero. If the polynmial is identical zero, the result is (still)
	 *         0.
	 * @since 2010-08-27
	 */
	public int ldegree() {
	 ...
	 * 
	 * @return The representation a0,a1,a2,a3,... This is a sort of opposite of
	 *         the ctor that takes a string as an argument.
	 * @since 2008-10-25
	 */
	@Override
	 ...
	 * high powers) are deleted. This modifies the polynomial on the stop (does
	 * not return another instance)
	 */
	 ...
	 *         newdeg =3, for example the polynomial returned has at most degree
	 *         3. If newdeg is larger than the degree of this, zeros (at the
	 *         higher orders of x) are appended. That polynomial would have
	 *         formal degree larger than this.
	 * @since 2008-10-26
	 */
