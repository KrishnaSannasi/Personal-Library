...
public class BigDecimalMath {
	 ...
	 *         of digits causes the result to have no valid digits left.
	 * @since 2009-05-29
	 * @author Richard J. Mathar
	 */
		...
		*/
		if(x.compareTo(BigDecimal.ZERO) < 0) {
			...
			*/
			...
			return resul; // got rid of .round(mc)
		}
		else {
			final double xDbl = x.doubleValue();
		...
		*/
		if(n <= 0) {
			...
			*/
			...
			return log3; // got rid of .round(mc)
		}
		else if(n == 5) {
			...
			*/
			...
			return log5; // got rid of .round(mc)
		}
		else if(n == 7) {
			...
			*/
			...
			return log7; // got rid of .round(mc)
		}
		else {
	...
	static public BigDecimal powRound(final BigDecimal x , final BigInteger n) {
		 ...
		 * range of the standard integers. This might, however, be implemented to
		 * decompose larger powers into cascaded calls to smaller ones.
		 */
