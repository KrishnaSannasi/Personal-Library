...
public class Voronoi {
    ...
    private VornoiEdge bisect(Site s1 , Site s2) {
    ...
    private Halfedge HEcreate(VornoiEdge e , int pm) {
        Halfedge answer;
        answer = new Halfedge();
        answer.ELedge = e;
        answer.ELpm = pm;
    ...
    private void clip_line(VornoiEdge e) {
    ...
    private void endpoint(VornoiEdge e , int lr , Site s) {
        e.ep[lr] = s;
        if(e.ep[RE - lr] == null) {
            return;
        }
